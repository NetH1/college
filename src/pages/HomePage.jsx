        ...
        <>
            <Header content={(<div>
                <div className="text-white flex flex-col justify-center items-center py-60">
                    <h1 className="text-center text-6xl w-[55%] font-bold"><span className="text-[#DBA833]">Поставка нефтепродуктов</span> в Москве и Московской области</h1>
                    <p className='text-center my-4'>От 1000 литров и от 46 рублей за литр</p>
