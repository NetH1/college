        ...
        <article className={`${styles.truck}`}>
            <div className={`container mx-auto py-40 mt-44`}>
                ...
                <div className="flex gap-x-4 mt-5">
                    ...
                    <button className='text-[#DBA833] bg-white py-2 px-24 rounded-md text-lg font-bold w-full'>Отправить</button>
                </div>
                <p className='float-right text-white underline mt-1'>Согласен с политикой конфиденциальности</p>
                </div>
            </div>
        </article>
    );
